                    ...
                    <ul className="question-list">
                      {questions.map((question, i) => (
                        <li className="question-item" key={question.id}>
                          <p className="question__title">Câu {i + 1}:</p>
            ...
            <div className="exam__right-box">
              <div className="exam-container">
                ...
                <p className="exam__note">
                  <strong>Chú ý:</strong> Khi bạn bắt đầu làm bài thi thì thời
                  gian sẽ được tính, bạn bắt buộc phải hoàn thành bài thi của
                  mình trong thời gian cho phép, quá thời gian quy định hệ thống
                  sẽ tự động dừng bài làm của bạn và trả kết quả.
                </p>
              </div>
            </div>
          </div>
